    ...
    <Card className="backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 border border-white/20 dark:border-gray-700/20 shadow-xl rounded-2xl overflow-hidden">
      ...
      <CardContent className="p-6 space-y-4">
        {hasChanges && (
          <Button
            onClick={handleSave}
            className="w-full h-12 flex items-center justify-start gap-3 bg-gradient-to-r from-green-400 to-emerald-500 shadow-md rounded-lg px-4 group"
          >
        ...
        {hasChanges && (
          <Button
            variant="outline"
            onClick={handleReset}
            className="w-full h-12 flex items-center justify-start gap-3 rounded-lg px-4 group"
          >
        ...
        <Button
          ...
          disabled={deleting}
          className="w-full h-12 flex items-center justify-start gap-3 rounded-lg px-4 group disabled:opacity-50"
        >
