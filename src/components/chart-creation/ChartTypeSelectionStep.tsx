...
function ChartTypeSelectionStep({
  onNext,
  onPrevious,
  onChartTypeSelect,
}: ChartTypeSelectionStepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">{t('chart_creation_chartType_subtitle')}</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <CardContent className="text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400">{chartType.description}</p>
                {isSelected && (
                  <div className="mt-3">
